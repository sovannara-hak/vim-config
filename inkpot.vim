...
if has("gui_running")
    ...
    hi CursorLine     gui=NONE   guifg=NONE      guibg=#332941
    hi CursorColumn   gui=NONE   guifg=NONE      guibg=#273333

    "hi Folded         gui=NONE   guifg=#cfcfcd   guibg=#4b208f
    hi Folded         gui=NONE   guifg=#cfcfcd   guibg=#332941
    ...
    hi TabLine        gui=NONE   guifg=#cfcfcd   guibg=#2e2e2e
    hi TabLineFill    gui=NONE   guifg=NONE      guibg=NONE
    hi TabLineSel     gui=BOLD   guifg=#ffffff   guibg=#4e4e8f
    ...
    if v:version >= 700
        ...
        hi PmenuSel       gui=BOLD   guifg=#eeeeee   guibg=#c080d0
